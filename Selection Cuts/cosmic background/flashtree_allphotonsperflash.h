...
// Wed Mar 22 20:06:37 2023 by ROOT version 6.26/04
...
#ifndef flashtree_allphotonsperflash_h
#define flashtree_allphotonsperflash_h
...
class flashtree_allphotonsperflash {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   flashtree_allphotonsperflash(TTree *tree=0);
   virtual ~flashtree_allphotonsperflash();
...
#ifdef flashtree_allphotonsperflash_cxx
flashtree_allphotonsperflash::flashtree_allphotonsperflash(TTree *tree) : fChain(0) 
{
...
flashtree_allphotonsperflash::~flashtree_allphotonsperflash()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t flashtree_allphotonsperflash::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t flashtree_allphotonsperflash::LoadTree(Long64_t entry)
{
...
void flashtree_allphotonsperflash::Init(TTree *tree)
{
...
Bool_t flashtree_allphotonsperflash::Notify()
{
...
void flashtree_allphotonsperflash::Show(Long64_t entry)
{
...
Int_t flashtree_allphotonsperflash::Cut(Long64_t entry)
{
...
#endif // #ifdef flashtree_allphotonsperflash_cxx
