...
// Fri Mar 24 16:08:23 2023 by ROOT version 6.26/04
...
#ifndef flashspreadclass_h
#define flashspreadclass_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   flashspreadclass(TTree *tree=0);
   virtual ~flashspreadclass();
...
#ifdef flashspreadclass_cxx
flashspreadclass::flashspreadclass(TTree *tree) : fChain(0) 
{
...
flashspreadclass::~flashspreadclass()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t flashspreadclass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t flashspreadclass::LoadTree(Long64_t entry)
{
...
void flashspreadclass::Init(TTree *tree)
{
...
Bool_t flashspreadclass::Notify()
{
...
void flashspreadclass::Show(Long64_t entry)
{
...
Int_t flashspreadclass::Cut(Long64_t entry)
{
...
#endif // #ifdef flashspreadclass_cxx
