...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   PhotonsPerOpDetClass_2(TTree *tree=0);
   virtual ~PhotonsPerOpDetClass_2();
...
#ifdef PhotonsPerOpDetClass_2_cxx
PhotonsPerOpDetClass_2::PhotonsPerOpDetClass_2(TTree *tree) : fChain(0) 
{
...
PhotonsPerOpDetClass_2::~PhotonsPerOpDetClass_2()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PhotonsPerOpDetClass_2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PhotonsPerOpDetClass_2::LoadTree(Long64_t entry)
{
...
void PhotonsPerOpDetClass_2::Init(TTree *tree)
{
...
Bool_t PhotonsPerOpDetClass_2::Notify()
{
...
void PhotonsPerOpDetClass_2::Show(Long64_t entry)
{
...
Int_t PhotonsPerOpDetClass_2::Cut(Long64_t entry)
{
...
#endif // #ifdef PhotonsPerOpDetClass_2_cxx
