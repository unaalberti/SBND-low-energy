...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   PhotonsPerOpDetClass(TTree *tree=0);
   virtual ~PhotonsPerOpDetClass();
...
#ifdef PhotonsPerOpDetClass_cxx
PhotonsPerOpDetClass::PhotonsPerOpDetClass(TTree *tree) : fChain(0) 
{
...
PhotonsPerOpDetClass::~PhotonsPerOpDetClass()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PhotonsPerOpDetClass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PhotonsPerOpDetClass::LoadTree(Long64_t entry)
{
...
void PhotonsPerOpDetClass::Init(TTree *tree)
{
...
Bool_t PhotonsPerOpDetClass::Notify()
{
...
void PhotonsPerOpDetClass::Show(Long64_t entry)
{
...
Int_t PhotonsPerOpDetClass::Cut(Long64_t entry)
{
...
#endif // #ifdef PhotonsPerOpDetClass_cxx
